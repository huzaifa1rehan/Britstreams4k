    ...
    <header style={{
      ...
      <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <nav style={{ display: 'flex', gap: '2rem', alignItems: 'center' }} className="desktop-nav">
          ...
          <Link href="/iptv-installation-guide" style={{ color: 'var(--muted)', textDecoration: 'none', fontWeight: 500, transition: 'color 0.2s ease' }} onMouseEnter={(e) => e.currentTarget.style.color = '#fff'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--muted)'}>Setup</Link>
          <Link href="/become-iptv-reseller" style={{ color: 'var(--muted)', textDecoration: 'none', fontWeight: 500, transition: 'color 0.2s ease' }} onMouseEnter={(e) => e.currentTarget.style.color = '#fff'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--muted)'}>Reseller</Link>
      ...
      {mobileMenuOpen && (
        <div className="animate-fade-in" style={{
          ...
          <Link href="/iptv-installation-guide" onClick={() => setMobileMenuOpen(false)} style={{ color: '#fff', fontSize: '1.125rem', fontWeight: 500, textDecoration: 'none' }}>Setup</Link>
          <Link href="/become-iptv-reseller" onClick={() => setMobileMenuOpen(false)} style={{ color: '#fff', fontSize: '1.125rem', fontWeight: 500, textDecoration: 'none' }}>Reseller</Link>
          <Link href="/contact-us" onClick={() => setMobileMenuOpen(false)} style={{ color: '#fff', fontSize: '1.125rem', fontWeight: 500, textDecoration: 'none' }}>Contact Us</Link>
